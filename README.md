...
4. Build APK release: `flutter build apk --dart-define-from-file="dart-defines/release/app_config.json"`
5. Check APK build at: `build/app/outputs/flutter-apk/app-release.apk`